...
const ImageEditor = ({
  ...
  return (
    <div className="fixed w-screen h-screen inset-0 bg-black bg-opacity-75 z-10 flex items-center justify-center">
      <div className="bg-black rounded-xl p-12 flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <div
            ...
            className={`cursor-pointer py-1 px-4 text-black rounded-full ${
